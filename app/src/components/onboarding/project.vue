  ...
  <div class="c-onboarding-project">
    <Constrain size="sm">
      <article>
        ...
        <p>In Operational, all your events, billing and user accounts belongs to a project.</p>
...
import FormProjectname from "@operational.co/components/form/form-projectname.vue";
export default {
  components: {
    Constrain,
    FormProjectname,
