<template>
	<div class="c-search">
		...
		<div class="c-search__categories" v-if="categories">
			<div class="c-search__categories__wrap">
				<div class="c-search__categories__inner">
					<a
		...
		>
			<div class="c-search__dropdown">
				<div class="c-search__dropdown__list">
					<a
						href="#"
						v-for="(name, i) in eventNames"
						:key="i"
						@click.prevent="addToSearch(name)"
					>
						{{ name }}
					</a>
				</div>
	...
	methods: {
		onClick: function (e) {
			if (this.currentCategory === e) {
				...
				this.$emit("onCategorySelected", e);
			}
		},
