  ...
  <div :class="['c-header', { hidden: hidden === true }, { active: menuActive === true }]">
    <div class="c-header__inner">
      <Constrain>
        ...
        <a class="btn btn-sm btn-fancy" href="https://app.operational.co?login"> Open app </a>
      </Constrain>
    </div>
    ...
    <div class="c-header__menu">
      <a :class="[{ active: route.includes('/pricing') }]" href="/pricing"> Pricing </a>
      <a :class="[{ active: route.includes('/articles') }]" href="/articles"> Articles </a>
      <a :class="[{ active: route.includes('/pitch') }]" href="/pitch"> Pitch </a>
      <a :class="[{ active: route.includes('/usecases') }]" href="/usecases"> Usecases </a>
      <a :class="[{ active: route.includes('/playground') }]" href="/playground"> Playground </a>
      <a :class="[{ active: route.includes('/api') }]" href="/api"> API </a>
    </div>
  </div>
</template>
