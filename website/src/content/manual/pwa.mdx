...
title: PWA
slug: pwa
description: Learn how to setup PWA for Operational.co
date: 2024-09-22
---
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/R4lbQNsGPfg" title="Operational setup using Docker image" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

PWA(progressive web app) is a mode under which Operational can run:
...
![Operational PWA](/images/pitch/ops_insitu.jpg)
...
- Open up app.operational.co
- Click on the install icon on the right side of the url baseUrl
- That's it. Operational should open up as a desktop app.
