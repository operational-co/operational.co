...
title: Setup
slug: setup
description: Best practices for setting up Operational.co inside your product
date: 2024-09-22
---
...
Hint: You can also combine similar events using [contexts](/docs/group-events-with-contexts). Example:
