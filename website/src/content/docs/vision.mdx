...
title: Vision
slug: vision
description: Long term vision for Operational.co
date: 2025-03-01
---

# Vision

Operational is a simple event tracker right now, but its long term destiny is to help founders manage their product and help them free up their time that is normally spend on operational issues.
...
- Functional open-source. Anyone with basic programming knowledge should be able to get an Operational instance up and running within minutes.
...
- Insane focus on the user interface. We want people absolutely not familiar with business ops to be able to use the heck out of Operational.
