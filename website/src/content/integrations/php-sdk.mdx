...
title: 'PHP SDK'
slug : 'php-sdk'
description: 'Operational.co PHP SDK'
date: 2025-05-09
---
...
Use [composer](https://packagist.org/packages/operational/sdk-php) to install Operational's PHP SDK. Run this inside your project:
