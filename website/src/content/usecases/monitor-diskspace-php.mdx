...
description: This guide shows how to monitor server disk space from your PHP app using Operational for alerts and metrics tracking.
date: 2025-05-22
tags:
  - php
  - server
...
Try out ready-to-paste code snippets inside the [Playground](https://operational.co/playground).