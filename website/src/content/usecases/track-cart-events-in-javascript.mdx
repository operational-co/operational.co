...
description: Learn to track shopping cart actions including add, remove, and checkout events in your JavaScript app with Operational
date: 2024-06-20
tags:
  - javascript
  - ecommerce
...
await ops.events.log(payloadAdd)
...
await ops.events.log(payloadRemove)
...
await ops.events.log(payloadCheckout)
...
await ops.events.log(payloadPurchase)
```

The code above shows how to track common cart events
in your JavaScript app using Operational.

### Conclusion

Operational saves time and hassle
