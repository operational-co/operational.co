...
For example, you can see when a post was edited and by which user.
...
3. Install the Operational SDK or configure API access for PHP.
4. Keep your API key safe to send events securely.
