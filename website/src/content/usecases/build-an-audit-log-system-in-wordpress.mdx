...
description: Learn how to build an audit log system in Wordpress using Operational to record user actions and site events efficiently.
date: 2024-06-23
tags:
  - wordpress
  - audit-log
...
Operational is an open source service for capturing events in your app. You can use it to send audit events from Wordpress to a dashboard.
...
$client->post('https://api.operational.co/events/ingest', [
  'headers' => [
...
Operational makes it simple to send and view events in one place.
