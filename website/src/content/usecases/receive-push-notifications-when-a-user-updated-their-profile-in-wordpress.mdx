...
description: Learn how to send real-time push notifications when a user updates their Wordpress profile using Operational.
date: 2025-05-22
tags:
  - wordpress
  - notifications
...
Try the [playground](https://operational.co/playground) to experiment with snippets.