...
description: Learn to record user cart events in your PHP e-commerce app using Operational for better sales insights and customer experience.
date: 2024-06-20
tags:
  - php
  - ecommerce
...
Learn more on the [Operational homepage](https://operational.co) or try the live code in the [playground](https://operational.co/playground).