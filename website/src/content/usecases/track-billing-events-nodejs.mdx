...
Operational is an open-source event tracking tool. You can use it to log and view billing events from your app in a single dashboard.

![Operational usage](https://operational.co/images/misc/ops-usage.jpg)

### Setting up Operational

1. Go to the signup page at [app.operational.co](https://app.operational2.co) and create an account.
