...
description: Learn how to track and monitor Node.js cronjobs with Operational. Detect failures, slow executions, and successful runs in real time.
date: 2025-05-22
tags:
  - nodejs
  - cron
...
## How Operational helps monitor cronjobs

Operational is an event tracking platform you can use to record cronjob runs and errors.
...
Operational displays these events in a timeline so you see patterns and catch problems early.
...
3. In your Node.js app folder run `npm install @operational.co/sdk`.
4. Import and initialize the SDK with your API key in your code.

## Tracking cronjob events

Below are examples of how to send different cronjob events to Operational using Node.js.
...
With Operational you can easily track cronjob executions in Node.js and get a clear view of failures or delays.
It saves time on manual checks and helps you react quickly when jobs misbehave.

Learn more at https://operational.co and try the playground to copy and paste code snippets: https://operational.co/playground
