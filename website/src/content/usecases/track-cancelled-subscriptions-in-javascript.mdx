...
description: Guide to monitoring and reporting subscription cancellations in your JavaScript app using Operational for timely alerts and analytics.
date: 2025-05-22
tags:
  - javascript
  - saas
...
Operational is an open-source event tracking tool that logs and displays your events in real time.

You can send cancellation events from your JavaScript app and view them on the dashboard.

<img src="https://operational.co/images/misc/ops-usage2.jpg" alt="Operational in action" />
...
It saves you time by handling event logging, storage, and real-time updates.
