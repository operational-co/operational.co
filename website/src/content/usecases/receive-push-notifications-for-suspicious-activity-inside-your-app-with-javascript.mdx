...
description: Learn how to send real-time push alerts for suspicious user activity in your JavaScript app using Operational's event tracking.
date: 2024-06-15
tags:
  - javascript
  - security
...
You can send custom events for errors, security checks, or user behavior to Operational.

When a suspicious event arrives, Operational can forward it as a push notification to your team’s phones or messaging channels.
...
```
This code sends a login attempt event. Operational will push an alert when it ingests this event.
...
With Operational, you can stop chasing unknown threats and get notified instantly when suspicious actions happen.

Learn more at https://operational.co and try code samples in our playground: https://operational.co/playground
