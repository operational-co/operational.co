...
description: Learn how to track user signup events in your SaaS using Operational to understand user growth and activation metrics easily.
date: 2024-06-07
tags:
  - saas
  - analytics
...
await ops.events.log(eventPayload);
```
...
Learn more on the [Operational homepage](https://operational.co). Try the [playground](https://operational.co/playground) to copy and paste snippets.
