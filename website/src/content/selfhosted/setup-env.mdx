...
title: Setup env
slug: setup-env
description: Learn how to setup .env files for your self-hosted Operational.co instance
date: 2025-03-15
---
...
# /api/v1/log is allowed from all urls so it can receive events without any cors issue.
