...
title: Docker
slug: docker
description: Docker setup for Operational.co
date: 2025-03-15
---
...
Alternatives we have ready-to-go images served via [Github Registry hub](https://github.com/operational-co/operational.co/pkgs/container/operational.co).
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/oPc856rvqX0" title="Operational setup using Docker image" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
5. Setup a Docker image
  Get the Docker image url from [here](https://github.com/operational-co/operational.co/pkgs/container/operational.co).
6. Enter env vars
...
Clone the repo at https://github.com/operational-co/operational.co
