...
description: Learn how to install Operational.co via dockerfile and Docker image
date: 2025-03-15
---
...
Just run `docker pull ghcr.io/operational-co/operational.co:latest` and this will pull the latest Operational.co image.
...
docker run -d \
  -p 80:80 \
  -p 4337:4337 \
  -e DATABASE_URL="mysql://root:password@127.0.0.1/operational-staging" \
...
- Clone the [github repo](https://github.com/operational-co/operational.co)
- `cd` into the repo
- Run `docker build -t operational .`
